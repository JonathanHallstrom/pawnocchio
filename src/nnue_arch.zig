...
pub const Weights = extern struct {
    ...
    l2w: [OUTPUT_BUCKET_COUNT][3 * L3_SIZE * L2_SIZE]i32 align(ALIGNMENT),
    ...
    fn l2wInference(self: *Weights) *align(64) [OUTPUT_BUCKET_COUNT][3 * L3_SIZE * L2_SIZE]i32 {
        return @ptrCast(&self.l2w);
    }

    fn l2wDisk(self: *Weights) *align(64) [3 * L2_SIZE][OUTPUT_BUCKET_COUNT][L3_SIZE]i32 {
        return @ptrCast(&self.l2w);
    }
