...
pub const PAWN_PAIR_INPUTS = false;
...
pub const ACCUMULATOR_TILE = std.math.gcd(ACCUMULATOR_VECTOR_COUNT, switch (simd.TARGET) {
...
pub const L1_PAIR_ORDER: [L1_PAIR_COUNT]u16 = IDENTITY;
