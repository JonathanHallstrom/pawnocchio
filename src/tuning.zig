...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 435;
    pub const quiet_history_bonus_offs: i32 = 316;
    pub const quiet_history_bonus_max: i32 = 2636;
    pub const quiet_history_penalty_mult: i32 = 227;
    pub const quiet_history_penalty_offs: i32 = 265;
    pub const quiet_history_penalty_max: i32 = 2024;
    pub const cont_history_bonus_mult: i32 = 410;
    pub const cont_history_bonus_offs: i32 = 325;
    pub const cont_history_bonus_max: i32 = 2594;
    pub const cont_history_penalty_mult: i32 = 220;
    pub const cont_history_penalty_offs: i32 = 265;
    pub const cont_history_penalty_max: i32 = 2029;
    pub const noisy_history_bonus_mult: i32 = 407;
    pub const noisy_history_bonus_offs: i32 = 320;
    pub const noisy_history_bonus_max: i32 = 2523;
    pub const noisy_history_penalty_mult: i32 = 228;
    pub const noisy_history_penalty_offs: i32 = 259;
    pub const noisy_history_penalty_max: i32 = 2055;
    pub const rfp_base: i32 = 58;
    pub const rfp_mult: i32 = 58;
    pub const rfp_improving_margin: i32 = 58;
    pub const rfp_worsening_margin: i32 = 10;
    pub const rfp_cutnode_margin: i32 = 19;
    pub const aspiration_initial: i32 = 19;
    pub const aspiration_multiplier: i32 = 2129;
    pub const lmr_quiet_base: i32 = 2528;
    pub const lmr_noisy_base: i32 = 2239;
    pub const lmr_quiet_log_mult: i32 = 227;
    pub const lmr_noisy_log_mult: i32 = 228;
    pub const lmr_quiet_depth_mult: i32 = 986;
    pub const lmr_noisy_depth_mult: i32 = 991;
    pub const lmr_quiet_legal_mult: i32 = 987;
    pub const lmr_noisy_legal_mult: i32 = 1016;
    pub const lmr_pv_mult: i32 = 1188;
    pub const lmr_cutnode_mult: i32 = 956;
    pub const lmr_improving_mult: i32 = 1014;
    pub const lmr_quiet_history_mult: i32 = 1017;
    pub const lmr_noisy_history_mult: i32 = 1018;
    pub const lmr_corrhist_mult: i32 = 11579;
    pub const lmr_ttmove_mult: i32 = 511;
    pub const nmp_base: i32 = 39450;
    pub const nmp_mult: i32 = 1122;
    pub const nmp_eval_reduction_scale: i32 = 29;
    pub const nmp_eval_reduction_max: i32 = 23562;
    ...
    pub const history_pruning_mult: i32 = -2265;
    pub const qs_futility_margin: i32 = 100;
    pub const corrhist_pawn_weight: i32 = 1040;
    pub const corrhist_nonpawn_weight: i32 = 534;
    pub const corrhist_countermove_weight: i32 = 1017;
    pub const corrhist_major_weight: i32 = 1052;
    pub const corrhist_minor_weight: i32 = 988;
    pub const lmp_legal_base: i32 = -3236;
    pub const lmp_standard_mult: i32 = 1071;
    pub const lmp_improving_mult: i32 = 1032;
