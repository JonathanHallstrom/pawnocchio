...
const tunable_defaults = struct {
    ...
    pub const cont5_ordering_weight: i32 = 903;
    pub const cont5_pruning_weight: i32 = 64;
    ...
    pub const lmp_standard_base: i32 = 2785;
    pub const lmp_improving_base: i32 = 3136;
...
pub const tunables = [_]Tunable{
    ...
    .{ .name = "cont5_ordering_weight", .default = tunable_defaults.cont5_ordering_weight, .min = 0, .max = 2048, .c_end = 128 },
    .{ .name = "cont5_pruning_weight", .default = tunable_defaults.cont5_pruning_weight, .min = 0, .max = 2048, .c_end = 128 },
...
pub const tunable_constants = if (do_tuning) struct {
    ...
    pub var cont5_ordering_weight = tunable_defaults.cont5_ordering_weight;
    pub var cont5_pruning_weight = tunable_defaults.cont5_pruning_weight;
