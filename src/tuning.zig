...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 513;
    pub const quiet_history_bonus_offs: i32 = 405;
    pub const quiet_history_bonus_max: i32 = 2406;
    pub const quiet_history_penalty_mult: i32 = 253;
    pub const quiet_history_penalty_offs: i32 = 353;
    pub const quiet_history_penalty_max: i32 = 1924;
    pub const cont_history_bonus_mult: i32 = 487;
    pub const cont_history_bonus_offs: i32 = 273;
    pub const cont_history_bonus_max: i32 = 2577;
    pub const cont_history_penalty_mult: i32 = 197;
    pub const cont_history_penalty_offs: i32 = 247;
    pub const cont_history_penalty_max: i32 = 1747;
    pub const noisy_history_bonus_mult: i32 = 302;
    pub const noisy_history_bonus_offs: i32 = 401;
    pub const noisy_history_bonus_max: i32 = 2561;
    pub const noisy_history_penalty_mult: i32 = 223;
    pub const noisy_history_penalty_offs: i32 = 187;
    pub const noisy_history_penalty_max: i32 = 2274;
    pub const rfp_base: i32 = 39;
    pub const rfp_mult: i32 = 58;
    pub const rfp_improving_margin: i32 = 64;
    pub const rfp_worsening_margin: i32 = 16;
    pub const rfp_cutnode_margin: i32 = 17;
    pub const rfp_corrplexity_mult: i32 = 23;
    pub const aspiration_initial: i32 = 15716;
    pub const aspiration_multiplier: i32 = 1702;
    pub const lmr_quiet_base: i32 = 3164;
    pub const lmr_noisy_base: i32 = 1966;
    pub const lmr_quiet_log_mult: i32 = 179;
    pub const lmr_noisy_log_mult: i32 = 206;
    pub const lmr_quiet_depth_mult: i32 = 893;
    pub const lmr_noisy_depth_mult: i32 = 892;
    pub const lmr_quiet_depth_offs: i32 = -122;
    pub const lmr_noisy_depth_offs: i32 = 140;
    pub const lmr_quiet_legal_mult: i32 = 1024;
    pub const lmr_noisy_legal_mult: i32 = 1063;
    pub const lmr_quiet_legal_offs: i32 = 236;
    pub const lmr_noisy_legal_offs: i32 = 217;
    pub const lmr_pv_mult: i32 = 791;
    pub const lmr_cutnode_mult: i32 = 1191;
    pub const lmr_improving_mult: i32 = 661;
    pub const lmr_quiet_history_mult: i32 = 671;
    pub const lmr_noisy_history_mult: i32 = 1017;
    pub const lmr_corrhist_mult: i32 = 10831;
    pub const lmr_ttmove_mult: i32 = 627;
    pub const lmr_ttpv_mult: i32 = 585;
    pub const lmr_dodeeper_margin: i32 = 68;
    pub const nmp_base: i32 = 48088;
    pub const nmp_mult: i32 = 940;
    pub const nmp_eval_reduction_scale: i32 = 33;
    pub const nmp_eval_reduction_max: i32 = 22003;
    pub const fp_base: i32 = 220;
    pub const fp_mult: i32 = 93;
    pub const qs_see_threshold: i32 = -71;
    pub const see_quiet_pruning_mult: i32 = -75;
    pub const see_noisy_pruning_mult: i32 = -56;
    pub const razoring_margin: i32 = 268;
    pub const history_pruning_mult: i32 = -3064;
    pub const qs_futility_margin: i32 = 104;
    pub const corrhist_pawn_weight: i32 = 759;
    pub const corrhist_nonpawn_weight: i32 = 644;
    pub const corrhist_countermove_weight: i32 = 1236;
    pub const corrhist_major_weight: i32 = 1134;
    pub const corrhist_minor_weight: i32 = 726;
    pub const lmp_standard_base: i32 = -3671;
    pub const lmp_improving_base: i32 = -3225;
    pub const lmp_standard_mult: i32 = 856;
    pub const lmp_improving_mult: i32 = 1335;
    pub const good_noisy_ordering_base: i32 = -1116;
    pub const good_noisy_ordering_mult: i32 = 1292;
    pub const see_pawn: i32 = 95;
    pub const see_knight: i32 = 376;
    pub const see_bishop: i32 = 360;
    pub const see_rook: i32 = 656;
    pub const see_queen: i32 = 868;
    pub const material_scaling_base: i32 = 8299;
    pub const material_scaling_pawn: i32 = 35;
    pub const material_scaling_knight: i32 = 400;
    pub const material_scaling_bishop: i32 = 396;
    pub const material_scaling_rook: i32 = 547;
