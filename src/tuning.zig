...
const tunable_defaults = struct {
    ...
    pub const lmp_standard_base: i32 = 2807;
    pub const lmp_improving_base: i32 = 3384;
    pub const lmp_standard_linear_mult: i32 = -379;
    pub const lmp_improving_linear_mult: i32 = 341;
    pub const lmp_standard_quadratic_mult: i32 = 612;
