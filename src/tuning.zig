...
const tunable_defaults = struct {
    ...
    pub const lmp_standard_base: i32 = 4453;
    pub const lmp_improving_base: i32 = 4659;
    pub const lmp_standard_linear_mult: i32 = -142;
    pub const lmp_improving_linear_mult: i32 = 273;
    pub const lmp_standard_quadratic_mult: i32 = 402;
    pub const lmp_improving_quadratic_mult: i32 = 1226;
