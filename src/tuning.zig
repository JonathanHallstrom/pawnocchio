...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 405;
    pub const quiet_history_bonus_offs: i32 = 320;
    pub const quiet_history_bonus_max: i32 = 2607;
    pub const quiet_history_penalty_mult: i32 = 216;
    pub const quiet_history_penalty_offs: i32 = 286;
    pub const quiet_history_penalty_max: i32 = 1825;
    pub const cont_history_bonus_mult: i32 = 445;
    pub const cont_history_bonus_offs: i32 = 297;
    pub const cont_history_bonus_max: i32 = 2886;
    pub const cont_history_penalty_mult: i32 = 233;
    pub const cont_history_penalty_offs: i32 = 279;
    pub const cont_history_penalty_max: i32 = 1887;
    pub const noisy_history_bonus_mult: i32 = 404;
    pub const noisy_history_bonus_offs: i32 = 346;
    pub const noisy_history_bonus_max: i32 = 2355;
    pub const noisy_history_penalty_mult: i32 = 220;
    pub const noisy_history_penalty_offs: i32 = 226;
    pub const noisy_history_penalty_max: i32 = 1907;
    ...
    pub const aspiration_initial: i32 = 17;
    pub const aspiration_multiplier: i32 = 2204;
    pub const lmr_quiet_base: i32 = 2350;
    pub const lmr_noisy_base: i32 = 2278;
    pub const lmr_quiet_log_mult: i32 = 215;
    pub const lmr_noisy_log_mult: i32 = 230;
    pub const lmr_quiet_depth_mult: i32 = 849;
    pub const lmr_noisy_depth_mult: i32 = 912;
    pub const lmr_quiet_legal_mult: i32 = 943;
    pub const lmr_noisy_legal_mult: i32 = 897;
    pub const lmr_pv_mult: i32 = 1324;
    pub const lmr_cutnode_mult: i32 = 1014;
    pub const lmr_improving_mult: i32 = 1019;
    pub const lmr_quiet_history_mult: i32 = 949;
    pub const lmr_noisy_history_mult: i32 = 1085;
    pub const lmr_corrhist_mult: i32 = 12311;
    pub const lmr_ttmove_mult: i32 = 537;
    pub const nmp_base: i32 = 46137;
    pub const nmp_mult: i32 = 1116;
    pub const nmp_eval_reduction_scale: i32 = 32;
    pub const nmp_eval_reduction_max: i32 = 23461;
    pub const fp_base: i32 = 270;
    pub const fp_mult: i32 = 106;
    pub const qs_see_threshold: i32 = -93;
    pub const see_quiet_pruning_mult: i32 = -62;
    pub const see_noisy_pruning_mult: i32 = -43;
    pub const razoring_margin: i32 = 189;
    pub const history_pruning_mult: i32 = -2521;
    pub const qs_futility_margin: i32 = 108;
    pub const corrhist_pawn_weight: i32 = 1003;
    pub const corrhist_nonpawn_weight: i32 = 551;
    pub const corrhist_countermove_weight: i32 = 1100;
    pub const corrhist_major_weight: i32 = 1093;
    pub const corrhist_minor_weight: i32 = 984;
    pub const lmp_legal_base: i32 = -3405;
    pub const lmp_standard_mult: i32 = 991;
    pub const lmp_improving_mult: i32 = 965;
    pub const nodetm_base: i32 = 1718;
    pub const nodetm_mult: i32 = 946;
    pub const soft_limit_base: i32 = 53;
    pub const soft_limit_incr: i32 = 574;
    pub const hard_limit_base: i32 = 191;
    pub const singular_depth_limit: i32 = 7;
    pub const singular_tt_depth_margin: i32 = 3;
    pub const singular_beta_mult: i32 = 16;
    pub const singular_depth_mult: i32 = 18;
