...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 430;
    pub const quiet_history_bonus_offs: i32 = 317;
    pub const quiet_history_bonus_max: i32 = 2654;
    pub const quiet_history_penalty_mult: i32 = 226;
    pub const quiet_history_penalty_offs: i32 = 266;
    pub const quiet_history_penalty_max: i32 = 2015;
    pub const cont_history_bonus_mult: i32 = 416;
    pub const cont_history_bonus_offs: i32 = 325;
    pub const cont_history_bonus_max: i32 = 2610;
    pub const cont_history_penalty_mult: i32 = 220;
    pub const cont_history_penalty_offs: i32 = 269;
    pub const cont_history_penalty_max: i32 = 2011;
    pub const noisy_history_bonus_mult: i32 = 408;
    pub const noisy_history_bonus_offs: i32 = 313;
    pub const noisy_history_bonus_max: i32 = 2535;
    pub const noisy_history_penalty_mult: i32 = 230;
    pub const noisy_history_penalty_offs: i32 = 258;
    pub const noisy_history_penalty_max: i32 = 2052;
    pub const rfp_margin: i32 = 58;
    pub const rfp_cutnode_margin: i32 = 19;
    pub const aspiration_initial: i32 = 19;
    pub const aspiration_multiplier: i32 = 2116;
    pub const lmr_quiet_base: i32 = 2536;
    pub const lmr_noisy_base: i32 = 2248;
    pub const lmr_quiet_log_mult: i32 = 230;
    pub const lmr_noisy_log_mult: i32 = 227;
    pub const lmr_quiet_depth_mult: i32 = 992;
    pub const lmr_noisy_depth_mult: i32 = 989;
    pub const lmr_quiet_legal_mult: i32 = 982;
    pub const lmr_noisy_legal_mult: i32 = 1015;
    pub const lmr_pv_mult: i32 = 1172;
    pub const lmr_cutnode_mult: i32 = 962;
    pub const lmr_improving_mult: i32 = 1016;
    pub const lmr_quiet_history_mult: i32 = 1020;
    pub const lmr_noisy_history_mult: i32 = 1026;
    pub const lmr_corrhist_mult: i32 = 11544;
    pub const lmr_ttmove_mult: i32 = 507;
    pub const nmp_base: i32 = 39774;
    pub const nmp_mult: i32 = 1124;
    pub const nmp_eval_reduction_scale: i32 = 29;
    pub const nmp_eval_reduction_max: i32 = 23671;
    pub const fp_base: i32 = 240;
    pub const fp_mult: i32 = 113;
    pub const qs_see_threshold: i32 = -102;
    pub const see_quiet_pruning_mult: i32 = -70;
    pub const see_noisy_pruning_mult: i32 = -47;
    pub const razoring_margin: i32 = 189;
    pub const history_pruning_mult: i32 = -2249;
    pub const qs_futility_margin: i32 = 99;
    pub const corrhist_pawn_weight: i32 = 1038;
    pub const corrhist_nonpawn_weight: i32 = 534;
    pub const corrhist_countermove_weight: i32 = 1009;
    pub const corrhist_major_weight: i32 = 1043;
    pub const corrhist_minor_weight: i32 = 977;
    pub const lmp_legal_base: i32 = -3236;
    pub const lmp_standard_mult: i32 = 1073;
    pub const lmp_improving_mult: i32 = 1039;
