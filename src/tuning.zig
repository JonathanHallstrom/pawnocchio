...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 268;
    pub const quiet_history_bonus_offs: i32 = 545;
    pub const quiet_history_bonus_max: i32 = 3579;
    pub const quiet_history_penalty_mult: i32 = 115;
    pub const quiet_history_penalty_offs: i32 = 376;
    pub const quiet_history_penalty_max: i32 = 1492;
    pub const cont_history_bonus_mult: i32 = 658;
    pub const cont_history_bonus_offs: i32 = 333;
    pub const cont_history_bonus_max: i32 = 2602;
    pub const cont_history_penalty_mult: i32 = 194;
    pub const cont_history_penalty_offs: i32 = 283;
    pub const cont_history_penalty_max: i32 = 1561;
    pub const noisy_history_bonus_mult: i32 = 417;
    pub const noisy_history_bonus_offs: i32 = 371;
    pub const noisy_history_bonus_max: i32 = 2543;
    pub const noisy_history_penalty_mult: i32 = 143;
    pub const noisy_history_penalty_offs: i32 = 128;
    pub const noisy_history_penalty_max: i32 = 2146;
    pub const rfp_base: i32 = 66;
    pub const rfp_mult: i32 = 48;
    pub const rfp_improving_margin: i32 = 94;
    pub const rfp_worsening_margin: i32 = 16;
    pub const rfp_cutnode_margin: i32 = 13;
    pub const rfp_corrplexity_mult: i32 = 21;
    pub const aspiration_initial: i32 = 11620;
    pub const aspiration_multiplier: i32 = 1222;
    pub const lmr_quiet_base: i32 = 3240;
    pub const lmr_noisy_base: i32 = 2245;
    pub const lmr_quiet_log_mult: i32 = 220;
    pub const lmr_noisy_log_mult: i32 = 161;
    pub const lmr_quiet_depth_mult: i32 = 521;
    pub const lmr_noisy_depth_mult: i32 = 775;
    pub const lmr_quiet_depth_offs: i32 = -617;
    pub const lmr_noisy_depth_offs: i32 = 23;
    pub const lmr_quiet_legal_mult: i32 = 658;
    pub const lmr_noisy_legal_mult: i32 = 1218;
    pub const lmr_quiet_legal_offs: i32 = 601;
    pub const lmr_noisy_legal_offs: i32 = 143;
    pub const lmr_pv_mult: i32 = 1188;
    pub const lmr_cutnode_mult: i32 = 920;
    pub const lmr_improving_mult: i32 = 491;
    pub const lmr_quiet_history_mult: i32 = 1134;
    pub const lmr_noisy_history_mult: i32 = 841;
    pub const lmr_corrhist_mult: i32 = 6533;
    pub const lmr_ttmove_mult: i32 = 707;
    pub const lmr_ttpv_mult: i32 = 731;
    pub const lmr_dodeeper_margin: i32 = 56;
    pub const nmp_base: i32 = 47265;
    pub const nmp_mult: i32 = 1232;
    pub const nmp_eval_reduction_scale: i32 = 45;
    pub const nmp_eval_reduction_max: i32 = 23676;
    pub const fp_base: i32 = 255;
    pub const fp_mult: i32 = 112;
    pub const qs_see_threshold: i32 = -126;
    pub const see_quiet_pruning_mult: i32 = -93;
    pub const see_noisy_pruning_mult: i32 = -71;
    pub const razoring_margin: i32 = 227;
    pub const history_pruning_mult: i32 = -2494;
    pub const qs_futility_margin: i32 = 134;
    pub const corrhist_pawn_weight: i32 = 219;
    pub const corrhist_nonpawn_weight: i32 = 596;
    pub const corrhist_countermove_weight: i32 = 1221;
    pub const corrhist_major_weight: i32 = 1281;
    pub const corrhist_minor_weight: i32 = 1505;
    pub const lmp_standard_base: i32 = -4544;
    pub const lmp_improving_base: i32 = -2917;
    pub const lmp_standard_mult: i32 = 838;
    pub const lmp_improving_mult: i32 = 1421;
    pub const good_noisy_ordering_base: i32 = -1526;
    pub const good_noisy_ordering_mult: i32 = 1689;
    pub const see_pawn: i32 = 83;
    pub const see_knight: i32 = 178;
    pub const see_bishop: i32 = 428;
    pub const see_rook: i32 = 712;
    pub const see_queen: i32 = 1167;
    pub const material_scaling_base: i32 = 9430;
    pub const material_scaling_pawn: i32 = 45;
    pub const material_scaling_knight: i32 = 155;
    pub const material_scaling_bishop: i32 = 370;
    pub const material_scaling_rook: i32 = 251;
    pub const material_scaling_queen: i32 = 1019;
    pub const multicut_fail_medium: i32 = 171;
    pub const rfp_fail_medium: i32 = 527;
    pub const tt_fail_medium: i32 = 380;
    pub const qs_tt_fail_medium: i32 = 200;
    pub const standpat_fail_medium: i32 = 43;
