...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 481;
    pub const quiet_history_bonus_offs: i32 = 380;
    pub const quiet_history_bonus_max: i32 = 2656;
    ...
    pub const cont_history_penalty_max: i32 = 1840;
    pub const noisy_history_bonus_mult: i32 = 306;
    pub const noisy_history_bonus_offs: i32 = 398;
    pub const noisy_history_bonus_max: i32 = 2402;
    pub const noisy_history_penalty_mult: i32 = 208;
    pub const noisy_history_penalty_offs: i32 = 170;
    pub const noisy_history_penalty_max: i32 = 1982;
    pub const rfp_base: i32 = 55;
    pub const rfp_mult: i32 = 54;
    ...
    pub const lmr_noisy_base: i32 = 1761;
    pub const lmr_quiet_log_mult: i32 = 200;
    pub const lmr_noisy_log_mult: i32 = 215;
    pub const lmr_quiet_depth_mult: i32 = 754;
    pub const lmr_noisy_depth_mult: i32 = 849;
    pub const lmr_quiet_depth_offs: i32 = -166;
    pub const lmr_noisy_depth_offs: i32 = 165;
    pub const lmr_quiet_legal_mult: i32 = 917;
    pub const lmr_noisy_legal_mult: i32 = 939;
    pub const lmr_quiet_legal_offs: i32 = 222;
    pub const lmr_noisy_legal_offs: i32 = -1;
    pub const lmr_pv_mult: i32 = 1156;
    pub const lmr_cutnode_mult: i32 = 1017;
    pub const lmr_improving_mult: i32 = 832;
    pub const lmr_quiet_history_mult: i32 = 786;
    pub const lmr_noisy_history_mult: i32 = 984;
    pub const lmr_corrhist_mult: i32 = 9474;
    pub const lmr_ttmove_mult: i32 = 629;
    pub const lmr_ttpv_mult: i32 = 512;
    pub const lmr_dodeeper_margin: i32 = 52;
    pub const nmp_base: i32 = 50695;
    pub const nmp_mult: i32 = 923;
    pub const nmp_eval_reduction_scale: i32 = 35;
    pub const nmp_eval_reduction_max: i32 = 24882;
    pub const fp_base: i32 = 295;
    pub const fp_mult: i32 = 93;
    pub const qs_see_threshold: i32 = -88;
    pub const see_quiet_pruning_mult: i32 = -70;
    pub const see_noisy_pruning_mult: i32 = -50;
    pub const razoring_margin: i32 = 225;
    pub const history_pruning_mult: i32 = -2949;
    pub const qs_futility_margin: i32 = 118;
    pub const corrhist_pawn_weight: i32 = 726;
    pub const corrhist_nonpawn_weight: i32 = 596;
    pub const corrhist_countermove_weight: i32 = 1146;
    pub const corrhist_major_weight: i32 = 1177;
    pub const corrhist_minor_weight: i32 = 922;
    pub const lmp_standard_base: i32 = -3734;
    pub const lmp_improving_base: i32 = -3028;
    pub const lmp_standard_mult: i32 = 867;
    pub const lmp_improving_mult: i32 = 1083;
    pub const good_noisy_ordering_base: i32 = 0;
    pub const good_noisy_ordering_mult: i32 = 1024;
    pub const see_pawn: i32 = 82;
    pub const see_knight: i32 = 313;
    ...
    pub const material_scaling_rook: i32 = 540;
    ...
    pub const singular_beta_mult: i32 = 393;
    pub const singular_depth_mult: i32 = 622;
    pub const singular_depth_offs: i32 = 731;
