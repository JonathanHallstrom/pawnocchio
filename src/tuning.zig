...
const tunable_defaults = struct {
    ...
    pub const cont1_pruning_weight: i32 = 896;
    pub const cont2_ordering_weight: i32 = 1024;
    pub const cont2_pruning_weight: i32 = 768;
    pub const cont4_ordering_weight: i32 = 512;
    pub const cont4_pruning_weight: i32 = 384;
