...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 477;
    pub const quiet_history_bonus_offs: i32 = 371;
    pub const quiet_history_bonus_max: i32 = 2697;
    pub const quiet_history_penalty_mult: i32 = 222;
    pub const quiet_history_penalty_offs: i32 = 318;
    pub const quiet_history_penalty_max: i32 = 1649;
    pub const cont_history_bonus_mult: i32 = 543;
    pub const cont_history_bonus_offs: i32 = 321;
    pub const cont_history_bonus_max: i32 = 2592;
    pub const cont_history_penalty_mult: i32 = 190;
    pub const cont_history_penalty_offs: i32 = 259;
    pub const cont_history_penalty_max: i32 = 1859;
    pub const noisy_history_bonus_mult: i32 = 309;
    pub const noisy_history_bonus_offs: i32 = 408;
    pub const noisy_history_bonus_max: i32 = 2435;
    pub const noisy_history_penalty_mult: i32 = 221;
    pub const noisy_history_penalty_offs: i32 = 169;
    pub const noisy_history_penalty_max: i32 = 1998;
    pub const rfp_base: i32 = 53;
    pub const rfp_mult: i32 = 52;
    pub const rfp_improving_margin: i32 = 72;
    pub const rfp_worsening_margin: i32 = 14;
    pub const rfp_cutnode_margin: i32 = 18;
    pub const aspiration_initial: i32 = 16295;
    pub const aspiration_multiplier: i32 = 1574;
    pub const lmr_quiet_base: i32 = 2619;
    pub const lmr_noisy_base: i32 = 1798;
    pub const lmr_quiet_log_mult: i32 = 198;
    pub const lmr_noisy_log_mult: i32 = 224;
    pub const lmr_quiet_depth_mult: i32 = 761;
    pub const lmr_noisy_depth_mult: i32 = 832;
    pub const lmr_quiet_depth_offs: i32 = -152;
    pub const lmr_noisy_depth_offs: i32 = 274;
    pub const lmr_quiet_legal_mult: i32 = 904;
    pub const lmr_noisy_legal_mult: i32 = 931;
    pub const lmr_quiet_legal_offs: i32 = 183;
    pub const lmr_noisy_legal_offs: i32 = 36;
    pub const lmr_pv_mult: i32 = 1151;
    pub const lmr_cutnode_mult: i32 = 976;
    pub const lmr_improving_mult: i32 = 863;
    pub const lmr_quiet_history_mult: i32 = 811;
    pub const lmr_noisy_history_mult: i32 = 993;
    pub const lmr_corrhist_mult: i32 = 9636;
    pub const lmr_ttmove_mult: i32 = 617;
    pub const lmr_dodeeper_margin: i32 = 52;
    pub const nmp_base: i32 = 51886;
    pub const nmp_mult: i32 = 932;
    pub const nmp_eval_reduction_scale: i32 = 36;
    pub const nmp_eval_reduction_max: i32 = 25461;
    pub const fp_base: i32 = 302;
    pub const fp_mult: i32 = 99;
    pub const qs_see_threshold: i32 = -83;
    pub const see_quiet_pruning_mult: i32 = -52;
    pub const see_noisy_pruning_mult: i32 = -48;
    pub const razoring_margin: i32 = 218;
    pub const history_pruning_mult: i32 = -2891;
    pub const qs_futility_margin: i32 = 115;
    pub const corrhist_pawn_weight: i32 = 744;
    pub const corrhist_nonpawn_weight: i32 = 584;
    pub const corrhist_countermove_weight: i32 = 1135;
    pub const corrhist_major_weight: i32 = 1142;
    pub const corrhist_minor_weight: i32 = 901;
    pub const lmp_standard_base: i32 = -3731;
    pub const lmp_improving_base: i32 = -2829;
    pub const lmp_standard_mult: i32 = 900;
    pub const lmp_improving_mult: i32 = 1081;
    pub const see_pawn: i32 = 82;
    pub const see_knight: i32 = 314;
    pub const see_bishop: i32 = 303;
    ...
    pub const material_scaling_bishop: i32 = 385;
    pub const material_scaling_rook: i32 = 544;
    pub const material_scaling_queen: i32 = 1031;
    pub const nodetm_base: i32 = 1597;
    pub const nodetm_mult: i32 = 1038;
    pub const eval_stab_base: i32 = 1239;
    pub const eval_stab_offs: i32 = 55;
    pub const move_stab_base: i32 = 1276;
    pub const move_stab_offs: i32 = 46;
    pub const soft_limit_base: i32 = 53;
    pub const soft_limit_incr: i32 = 596;
    pub const hard_limit_phase_mult: i32 = 122;
    pub const hard_limit_base: i32 = 204;
    pub const singular_beta_mult: i32 = 377;
    pub const singular_depth_mult: i32 = 640;
    pub const singular_depth_offs: i32 = 735;
