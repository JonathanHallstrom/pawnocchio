...
pub const tunables = [_]Tunable{
    .{ .name = "rfp_mult", .default = tunable_defaults.rfp_mult, .min = 0, .max = 300 },

    .{ .name = "quiesce_see_pruning_threshold", .default = tunable_defaults.quiesce_see_pruning_threshold, .min = -200, .max = 0 },
    .{ .name = "quiesce_futility_margin", .default = tunable_defaults.quiesce_futility_margin, .min = -200, .max = 200 },

    .{ .name = "see_quiet_pruning_mult", .default = tunable_defaults.see_quiet_pruning_mult, .min = -200, .max = 0 },
    .{ .name = "see_noisy_pruning_mult", .default = tunable_defaults.see_noisy_pruning_mult, .min = -200, .max = 0 },

    .{ .name = "lmr_base", .default = tunable_defaults.lmr_base, .min = 0, .max = 8192 },
    .{ .name = "lmr_depth_mult", .default = tunable_defaults.lmr_depth_mult, .min = 1, .max = 4096 },
    .{ .name = "lmr_improving_mult", .default = tunable_defaults.lmr_improving_mult, .min = 1, .max = 2048 },
    .{ .name = "lmr_pv_mult", .default = tunable_defaults.lmr_pv_mult, .min = 1, .max = 2048 },

    .{ .name = "double_extension_margin", .default = tunable_defaults.double_extension_margin, .min = 0, .max = 64 },

    .{ .name = "razoring_margin", .default = tunable_defaults.razoring_margin, .min = 0, .max = 400 },

    .{ .name = "singular_beta_depth_mult", .default = tunable_defaults.singular_beta_depth_mult, .min = 0, .max = 400 },

    .{ .name = "history_bonus_mult", .default = tunable_defaults.history_bonus_mult, .min = 100, .max = 300 },
    .{ .name = "history_bonus_offs", .default = tunable_defaults.history_bonus_offs, .min = 100, .max = 300 },
    .{ .name = "history_bonus_max", .default = tunable_defaults.history_bonus_max, .min = 1000, .max = 3000 },
};
