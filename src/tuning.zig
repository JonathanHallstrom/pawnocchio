...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 250;
    pub const quiet_history_bonus_offs: i32 = 321;
    pub const quiet_history_bonus_max: i32 = 3965;
    pub const quiet_history_penalty_mult: i32 = 290;
    pub const quiet_history_penalty_offs: i32 = 327;
    pub const quiet_history_penalty_max: i32 = 1963;
    pub const cont_history_bonus_mult: i32 = 411;
    pub const cont_history_bonus_offs: i32 = 383;
    pub const cont_history_bonus_max: i32 = 2042;
    pub const cont_history_penalty_mult: i32 = 156;
    pub const cont_history_penalty_offs: i32 = 256;
    pub const cont_history_penalty_max: i32 = 2604;
    pub const noisy_history_bonus_mult: i32 = 356;
    pub const noisy_history_bonus_offs: i32 = 519;
    pub const noisy_history_bonus_max: i32 = 1557;
    pub const noisy_history_penalty_mult: i32 = 138;
    pub const noisy_history_penalty_offs: i32 = 167;
    pub const noisy_history_penalty_max: i32 = 1890;
    pub const rfp_base: i32 = 35;
    pub const rfp_mult: i32 = 58;
    pub const rfp_improving_margin: i32 = 59;
    pub const rfp_worsening_margin: i32 = 9;
    pub const rfp_cutnode_margin: i32 = 9;
    pub const aspiration_initial: i32 = 8781;
    pub const aspiration_multiplier: i32 = 1755;
    pub const lmr_quiet_base: i32 = 2368;
    pub const lmr_noisy_base: i32 = 1421;
    pub const lmr_quiet_log_mult: i32 = 187;
    pub const lmr_noisy_log_mult: i32 = 228;
    pub const lmr_quiet_depth_mult: i32 = 842;
    pub const lmr_noisy_depth_mult: i32 = 551;
    pub const lmr_quiet_depth_offs: i32 = -186;
    pub const lmr_noisy_depth_offs: i32 = 233;
    pub const lmr_quiet_legal_mult: i32 = 1180;
    pub const lmr_noisy_legal_mult: i32 = 953;
    pub const lmr_quiet_legal_offs: i32 = 269;
    pub const lmr_noisy_legal_offs: i32 = 174;
    pub const lmr_pv_mult: i32 = 965;
    pub const lmr_cutnode_mult: i32 = 1299;
    pub const lmr_improving_mult: i32 = 762;
    pub const lmr_quiet_history_mult: i32 = 928;
    pub const lmr_noisy_history_mult: i32 = 534;
    pub const lmr_corrhist_mult: i32 = 12457;
    pub const lmr_ttmove_mult: i32 = 727;
    pub const lmr_dodeeper_margin: i32 = 67;
    pub const nmp_base: i32 = 38914;
    pub const nmp_mult: i32 = 1318;
    pub const nmp_eval_reduction_scale: i32 = 41;
    pub const nmp_eval_reduction_max: i32 = 32768;
    pub const fp_base: i32 = 277;
    pub const fp_mult: i32 = 133;
    pub const qs_see_threshold: i32 = -45;
    pub const see_quiet_pruning_mult: i32 = -42;
    pub const see_noisy_pruning_mult: i32 = -78;
    pub const razoring_margin: i32 = 228;
    pub const history_pruning_mult: i32 = -2126;
    pub const qs_futility_margin: i32 = 128;
    pub const corrhist_pawn_weight: i32 = 910;
    pub const corrhist_nonpawn_weight: i32 = 844;
    pub const corrhist_countermove_weight: i32 = 1653;
    pub const corrhist_major_weight: i32 = 1423;
    pub const corrhist_minor_weight: i32 = 1020;
    pub const lmp_standard_base: i32 = -2717;
    pub const lmp_improving_base: i32 = -2825;
    pub const lmp_standard_mult: i32 = 835;
    pub const lmp_improving_mult: i32 = 1309;
    pub const see_pawn: i32 = 88;
    pub const see_knight: i32 = 227;
    pub const see_bishop: i32 = 245;
    pub const see_rook: i32 = 411;
    pub const see_queen: i32 = 783;
    pub const material_scaling_base: i32 = 11564;
    pub const material_scaling_pawn: i32 = 32;
    pub const material_scaling_knight: i32 = 491;
    pub const material_scaling_bishop: i32 = 447;
    pub const material_scaling_rook: i32 = 745;
    pub const material_scaling_queen: i32 = 954;
    pub const nodetm_base: i32 = 1922;
    pub const nodetm_mult: i32 = 1004;
    pub const eval_stab_base: i32 = 1123;
    pub const eval_stab_offs: i32 = 52;
    pub const move_stab_base: i32 = 1160;
    pub const move_stab_offs: i32 = 35;
    pub const soft_limit_base: i32 = 48;
    pub const soft_limit_incr: i32 = 693;
    pub const hard_limit_phase_mult: i32 = 108;
    pub const hard_limit_base: i32 = 202;
    pub const singular_beta_mult: i32 = 254;
    pub const singular_depth_mult: i32 = 525;
    pub const singular_depth_offs: i32 = 743;
