...
const tunable_defaults = struct {
    ...
    pub const quiesce_see_pruning_threshold: i32 = -103;
    pub const quiesce_futility_margin: i32 = 97;

    pub const see_quiet_pruning_mult: i32 = -80;
    pub const see_noisy_pruning_mult: i32 = -51;

    pub const lmr_base: i32 = 3062;
    pub const lmr_depth_mult: i32 = 263;
    ...
    pub const razoring_margin: i32 = 209;

    pub const history_bonus_mult: i32 = 299;
    pub const history_bonus_offs: i32 = 297;
    pub const history_bonus_max: i32 = 2317;

    pub const history_malus_mult: i32 = 289;
    pub const history_malus_offs: i32 = 300;
    pub const history_malus_max: i32 = 2329;

    pub const pawn_corrhist_weight: i32 = 1024;
    pub const nonpawn_corrhist_weight: i32 = 1024;

    pub const aspiration_window_mult: i32 = 2046;
    pub const aspiration_window_diff_mult: i32 = 1024;
    pub const aspiration_window_lower_bound: i32 = 15361;
    pub const aspiration_window_upper_bound: i32 = 102398;
