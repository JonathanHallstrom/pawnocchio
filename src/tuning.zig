...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 441;
    pub const quiet_history_bonus_offs: i32 = 464;
    pub const quiet_history_bonus_max: i32 = 3028;
    pub const quiet_history_penalty_mult: i32 = 159;
    pub const quiet_history_penalty_offs: i32 = 423;
    pub const quiet_history_penalty_max: i32 = 1788;
    pub const cont_history_bonus_mult: i32 = 492;
    pub const cont_history_bonus_offs: i32 = 285;
    pub const cont_history_bonus_max: i32 = 3522;
    pub const cont_history_penalty_mult: i32 = 174;
    pub const cont_history_penalty_offs: i32 = 353;
    pub const cont_history_penalty_max: i32 = 1892;
    pub const noisy_history_bonus_mult: i32 = 371;
    pub const noisy_history_bonus_offs: i32 = 358;
    pub const noisy_history_bonus_max: i32 = 2454;
    pub const noisy_history_penalty_mult: i32 = 252;
    pub const noisy_history_penalty_offs: i32 = 121;
    pub const noisy_history_penalty_max: i32 = 2278;
    pub const rfp_base: i32 = 37;
    pub const rfp_mult: i32 = 71;
    pub const rfp_improving_margin: i32 = 74;
    pub const rfp_worsening_margin: i32 = 11;
    pub const rfp_cutnode_margin: i32 = 22;
    pub const rfp_corrplexity_mult: i32 = 13;
    pub const aspiration_initial: i32 = 12313;
    pub const aspiration_multiplier: i32 = 1438;
    pub const lmr_quiet_base: i32 = 2559;
    pub const lmr_noisy_base: i32 = 2178;
    pub const lmr_quiet_log_mult: i32 = 243;
    pub const lmr_noisy_log_mult: i32 = 190;
    pub const lmr_quiet_depth_mult: i32 = 759;
    pub const lmr_noisy_depth_mult: i32 = 554;
    pub const lmr_quiet_depth_offs: i32 = 4;
    pub const lmr_noisy_depth_offs: i32 = 44;
    pub const lmr_quiet_legal_mult: i32 = 1040;
    pub const lmr_noisy_legal_mult: i32 = 849;
    pub const lmr_quiet_legal_offs: i32 = 102;
    pub const lmr_noisy_legal_offs: i32 = -411;
    pub const lmr_quiet_history_mult: i32 = 840;
    pub const lmr_noisy_history_mult: i32 = 1541;
    pub const lmr_corrhist_mult: i32 = 8723;
    pub const lmr_dodeeper_margin: i32 = 54;
    pub const nmp_base: i32 = 56133;
    pub const nmp_mult: i32 = 641;
    pub const nmp_eval_reduction_scale: i32 = 31;
    pub const nmp_eval_reduction_max: i32 = 22063;
    pub const fp_base: i32 = 236;
    pub const fp_mult: i32 = 102;
    pub const fp_hist_mult: i32 = 97;
    pub const qs_see_threshold: i32 = -91;
    pub const see_quiet_pruning_mult: i32 = -91;
    pub const see_noisy_pruning_mult: i32 = -39;
    pub const razoring_margin: i32 = 166;
    pub const history_pruning_offs: i32 = 441;
    pub const history_pruning_mult: i32 = -3147;
    pub const qs_futility_margin: i32 = 95;
    pub const corrhist_pawn_weight: i32 = 551;
    pub const corrhist_nonpawn_weight: i32 = 744;
    pub const corrhist_countermove_weight: i32 = 996;
    pub const corrhist_major_weight: i32 = 1224;
    pub const corrhist_minor_weight: i32 = 992;
    pub const lmp_standard_base: i32 = 3473;
    pub const lmp_improving_base: i32 = 4086;
    pub const lmp_standard_linear_mult: i32 = 865;
    pub const lmp_improving_linear_mult: i32 = 563;
    pub const lmp_standard_quadratic_mult: i32 = 2074;
    pub const lmp_improving_quadratic_mult: i32 = 1583;
    pub const good_noisy_ordering_base: i32 = -63;
    pub const good_noisy_ordering_mult: i32 = 887;
    pub const see_pawn_pruning: i32 = 83;
    pub const see_knight_pruning: i32 = 354;
    pub const see_bishop_pruning: i32 = 339;
    pub const see_rook_pruning: i32 = 674;
    pub const see_queen_pruning: i32 = 1291;
    pub const see_pawn_ordering: i32 = 73;
    pub const see_knight_ordering: i32 = 324;
    pub const see_bishop_ordering: i32 = 277;
    pub const see_rook_ordering: i32 = 629;
    pub const see_queen_ordering: i32 = 921;
    pub const mvv_mult: i32 = 859;
    pub const material_scaling_base: i32 = 11283;
    pub const material_scaling_pawn: i32 = 10;
    pub const material_scaling_knight: i32 = 341;
    pub const material_scaling_bishop: i32 = 490;
    pub const material_scaling_rook: i32 = 533;
    pub const material_scaling_queen: i32 = 1154;
    pub const multicut_fail_medium: i32 = 102;
    pub const rfp_fail_medium: i32 = 546;
    pub const tt_fail_medium: i32 = 94;
    pub const qs_tt_fail_medium: i32 = 18;
    pub const standpat_fail_medium: i32 = 61;
    pub const nodetm_base: i32 = 1449;
    pub const nodetm_mult: i32 = 1115;
    pub const eval_stab_margin: i32 = 21;
    pub const eval_stab_base: i32 = 1294;
    pub const eval_stab_offs: i32 = 55;
    pub const move_stab_base: i32 = 1243;
    pub const move_stab_offs: i32 = 45;
    pub const soft_limit_base: i32 = 57;
    pub const soft_limit_incr: i32 = 668;
    pub const hard_limit_phase_mult: i32 = 130;
    pub const hard_limit_base: i32 = 229;
    pub const singular_beta_mult: i32 = 387;
    pub const singular_depth_mult: i32 = 573;
    pub const singular_depth_offs: i32 = 842;
    pub const singular_dext_margin: i32 = 18;
};
