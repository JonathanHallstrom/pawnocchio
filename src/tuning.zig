...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 432;
    pub const quiet_history_bonus_offs: i32 = 315;
    pub const quiet_history_bonus_max: i32 = 2664;
    pub const quiet_history_penalty_mult: i32 = 225;
    pub const quiet_history_penalty_offs: i32 = 262;
    pub const quiet_history_penalty_max: i32 = 2028;
    pub const cont_history_bonus_mult: i32 = 406;
    pub const cont_history_bonus_offs: i32 = 321;
    pub const cont_history_bonus_max: i32 = 2588;
    pub const cont_history_penalty_mult: i32 = 219;
    pub const cont_history_penalty_offs: i32 = 264;
    pub const cont_history_penalty_max: i32 = 2064;
    pub const noisy_history_bonus_mult: i32 = 406;
    pub const noisy_history_bonus_offs: i32 = 319;
    pub const noisy_history_bonus_max: i32 = 2551;
    pub const noisy_history_penalty_mult: i32 = 227;
    pub const noisy_history_penalty_offs: i32 = 257;
    pub const noisy_history_penalty_max: i32 = 2049;
    pub const rfp_base: i32 = 58;
    pub const rfp_mult: i32 = 57;
    pub const rfp_improving_margin: i32 = 57;
    pub const rfp_worsening_margin: i32 = 10;
    pub const rfp_cutnode_margin: i32 = 19;
    pub const aspiration_initial: i32 = 19;
    pub const aspiration_multiplier: i32 = 2110;
    pub const lmr_quiet_base: i32 = 2553;
    pub const lmr_noisy_base: i32 = 2248;
    pub const lmr_quiet_log_mult: i32 = 229;
    pub const lmr_noisy_log_mult: i32 = 229;
    pub const lmr_quiet_depth_mult: i32 = 964;
    pub const lmr_noisy_depth_mult: i32 = 981;
    pub const lmr_quiet_legal_mult: i32 = 961;
    pub const lmr_noisy_legal_mult: i32 = 1031;
    pub const lmr_pv_mult: i32 = 1184;
    pub const lmr_cutnode_mult: i32 = 963;
    pub const lmr_improving_mult: i32 = 1026;
    pub const lmr_quiet_history_mult: i32 = 1019;
    pub const lmr_noisy_history_mult: i32 = 1017;
    pub const lmr_corrhist_mult: i32 = 11514;
    pub const lmr_ttmove_mult: i32 = 508;
    pub const nmp_base: i32 = 40036;
    pub const nmp_mult: i32 = 1126;
    pub const nmp_eval_reduction_scale: i32 = 29;
    pub const nmp_eval_reduction_max: i32 = 23743;
    ...
    pub const history_pruning_mult: i32 = -2286;
    pub const qs_futility_margin: i32 = 100;
    pub const corrhist_pawn_weight: i32 = 1051;
    pub const corrhist_nonpawn_weight: i32 = 536;
    pub const corrhist_countermove_weight: i32 = 1014;
    pub const corrhist_major_weight: i32 = 1041;
    pub const corrhist_minor_weight: i32 = 986;
    pub const lmp_legal_base: i32 = -3218;
    pub const lmp_standard_mult: i32 = 1054;
    pub const lmp_improving_mult: i32 = 1025;
