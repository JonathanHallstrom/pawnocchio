...
const tunable_defaults = struct {
    ...
    pub const singular_dnegext_margin: i32 = 14;
};
...
pub const tunables = [_]Tunable{
    ...
    .{ .name = "singular_dnegext_margin", .default = tunable_defaults.singular_dnegext_margin },
};
...
pub const tunable_constants = if (do_tuning) struct {
    ...
    pub var singular_dnegext_margin = tunable_defaults.singular_dnegext_margin;
