...
const tunable_defaults = struct {
    ...
    pub const quiet_history_bonus_offs: i32 = 354;
    pub const quiet_history_bonus_max: i32 = 2667;
    pub const quiet_history_penalty_mult: i32 = 185;
    pub const quiet_history_penalty_offs: i32 = 282;
    pub const quiet_history_penalty_max: i32 = 1848;
    pub const cont_history_bonus_mult: i32 = 571;
    pub const cont_history_bonus_offs: i32 = 226;
    pub const cont_history_bonus_max: i32 = 3060;
    pub const cont_history_penalty_mult: i32 = 177;
    pub const cont_history_penalty_offs: i32 = 282;
    pub const cont_history_penalty_max: i32 = 1863;
    pub const noisy_history_bonus_mult: i32 = 300;
    pub const noisy_history_bonus_offs: i32 = 384;
    pub const noisy_history_bonus_max: i32 = 2474;
    pub const noisy_history_penalty_mult: i32 = 234;
    pub const noisy_history_penalty_offs: i32 = 207;
    pub const noisy_history_penalty_max: i32 = 1890;
    pub const rfp_base: i32 = 54;
    ...
    pub const aspiration_initial: i32 = 1005;
    pub const aspiration_score_mult: i32 = 15028;
    pub const aspiration_multiplier: i32 = 1367;
    pub const lmr_quiet_base: i32 = 2982;
    pub const lmr_noisy_base: i32 = 1908;
    pub const lmr_quiet_log_mult: i32 = 161;
    pub const lmr_noisy_log_mult: i32 = 240;
    pub const lmr_quiet_depth_mult: i32 = 806;
    pub const lmr_noisy_depth_mult: i32 = 647;
    pub const lmr_quiet_depth_offs: i32 = -155;
    pub const lmr_noisy_depth_offs: i32 = 145;
    pub const lmr_quiet_legal_mult: i32 = 938;
    pub const lmr_noisy_legal_mult: i32 = 1055;
    pub const lmr_quiet_legal_offs: i32 = 7;
    pub const lmr_noisy_legal_offs: i32 = -118;
    pub const lmr_quiet_history_mult: i32 = 887;
    pub const lmr_noisy_history_mult: i32 = 1029;
    pub const lmr_corrhist_mult: i32 = 8320;
    pub const lmr_dodeeper_margin: i32 = 53;
    pub const nmp_base: i32 = 51973;
    pub const nmp_mult: i32 = 1038;
    pub const nmp_eval_reduction_scale: i32 = 32;
    pub const nmp_eval_reduction_max: i32 = 26362;
    pub const fp_base: i32 = 283;
    pub const fp_mult: i32 = 86;
    pub const fp_hist_mult: i32 = 112;
    pub const qs_see_threshold: i32 = -67;
    pub const see_quiet_pruning_mult: i32 = -77;
    pub const see_noisy_pruning_mult: i32 = -42;
    pub const razoring_margin: i32 = 201;
    pub const history_pruning_offs: i32 = 886;
    pub const history_pruning_mult: i32 = -2847;
    pub const qs_futility_margin: i32 = 115;
    pub const corrhist_pawn_weight: i32 = 652;
    pub const corrhist_nonpawn_weight: i32 = 630;
    pub const corrhist_countermove_weight: i32 = 1124;
    pub const corrhist_major_weight: i32 = 1513;
    pub const corrhist_minor_weight: i32 = 1143;
    pub const lmp_standard_base: i32 = 3768;
    pub const lmp_improving_base: i32 = 2022;
    pub const lmp_standard_linear_mult: i32 = 317;
    pub const lmp_improving_linear_mult: i32 = -241;
    pub const lmp_standard_quadratic_mult: i32 = 1199;
    pub const lmp_improving_quadratic_mult: i32 = 1305;
    pub const good_noisy_ordering_base: i32 = 75;
    pub const good_noisy_ordering_mult: i32 = 1078;
    pub const see_pawn_pruning: i32 = 70;
    pub const see_knight_pruning: i32 = 307;
    pub const see_bishop_pruning: i32 = 329;
    pub const see_rook_pruning: i32 = 541;
    pub const see_queen_pruning: i32 = 859;
    pub const see_pawn_ordering: i32 = 75;
    pub const see_knight_ordering: i32 = 280;
    pub const see_bishop_ordering: i32 = 317;
    pub const see_rook_ordering: i32 = 665;
    pub const see_queen_ordering: i32 = 866;
    pub const mvv_mult: i32 = 1307;
    pub const material_scaling_base: i32 = 9079;
    pub const material_scaling_pawn: i32 = 6;
    pub const material_scaling_knight: i32 = 346;
    pub const material_scaling_bishop: i32 = 404;
    pub const material_scaling_rook: i32 = 518;
    pub const material_scaling_queen: i32 = 987;
    pub const multicut_fail_medium: i32 = 29;
    pub const rfp_fail_medium: i32 = 541;
    pub const tt_fail_medium: i32 = 15;
    pub const qs_tt_fail_medium: i32 = 2;
    pub const standpat_fail_medium: i32 = 19;
    pub const nodetm_base: i32 = 1512;
    pub const nodetm_mult: i32 = 1022;
    pub const eval_stab_margin: i32 = 20;
    pub const eval_stab_base: i32 = 1288;
    pub const eval_stab_offs: i32 = 52;
    pub const move_stab_base: i32 = 1346;
    pub const move_stab_offs: i32 = 51;
    pub const soft_limit_base: i32 = 56;
    pub const soft_limit_incr: i32 = 580;
    pub const hard_limit_phase_mult: i32 = 136;
    pub const hard_limit_base: i32 = 204;
    pub const singular_beta_mult: i32 = 361;
    pub const singular_depth_mult: i32 = 556;
    pub const singular_depth_offs: i32 = 638;
