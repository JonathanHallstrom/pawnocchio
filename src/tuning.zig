...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 346;
    pub const quiet_history_bonus_offs: i32 = 350;
    pub const quiet_history_bonus_max: i32 = 3177;
    pub const quiet_history_penalty_mult: i32 = 251;
    pub const quiet_history_penalty_offs: i32 = 324;
    pub const quiet_history_penalty_max: i32 = 1706;
    pub const cont_history_bonus_mult: i32 = 475;
    pub const cont_history_bonus_offs: i32 = 373;
    pub const cont_history_bonus_max: i32 = 2309;
    pub const cont_history_penalty_mult: i32 = 181;
    pub const cont_history_penalty_offs: i32 = 240;
    pub const cont_history_penalty_max: i32 = 2501;
    pub const noisy_history_bonus_mult: i32 = 329;
    pub const noisy_history_bonus_offs: i32 = 458;
    pub const noisy_history_bonus_max: i32 = 1810;
    pub const noisy_history_penalty_mult: i32 = 156;
    pub const noisy_history_penalty_offs: i32 = 146;
    pub const noisy_history_penalty_max: i32 = 1975;
    pub const rfp_base: i32 = 47;
    pub const rfp_mult: i32 = 62;
    pub const rfp_improving_margin: i32 = 62;
    pub const rfp_worsening_margin: i32 = 11;
    pub const rfp_cutnode_margin: i32 = 12;
    pub const aspiration_initial: i32 = 11966;
    pub const aspiration_multiplier: i32 = 1659;
    pub const lmr_quiet_base: i32 = 2764;
    pub const lmr_noisy_base: i32 = 1327;
    pub const lmr_quiet_log_mult: i32 = 212;
    pub const lmr_noisy_log_mult: i32 = 246;
    pub const lmr_quiet_depth_mult: i32 = 858;
    pub const lmr_noisy_depth_mult: i32 = 760;
    pub const lmr_quiet_depth_offs: i32 = -141;
    pub const lmr_noisy_depth_offs: i32 = 175;
    pub const lmr_quiet_legal_mult: i32 = 1184;
    pub const lmr_noisy_legal_mult: i32 = 955;
    pub const lmr_quiet_legal_offs: i32 = 53;
    pub const lmr_noisy_legal_offs: i32 = 146;
    pub const lmr_pv_mult: i32 = 966;
    pub const lmr_cutnode_mult: i32 = 1399;
    pub const lmr_improving_mult: i32 = 862;
    pub const lmr_quiet_history_mult: i32 = 975;
    pub const lmr_noisy_history_mult: i32 = 532;
    pub const lmr_corrhist_mult: i32 = 11168;
    pub const lmr_ttmove_mult: i32 = 780;
    pub const lmr_dodeeper_margin: i32 = 66;
    pub const nmp_base: i32 = 29918;
    pub const nmp_mult: i32 = 1251;
    pub const nmp_eval_reduction_scale: i32 = 37;
    pub const nmp_eval_reduction_max: i32 = 31229;
    pub const fp_base: i32 = 297;
    pub const fp_mult: i32 = 129;
    pub const qs_see_threshold: i32 = -60;
    pub const see_quiet_pruning_mult: i32 = -53;
    pub const see_noisy_pruning_mult: i32 = -74;
    pub const razoring_margin: i32 = 203;
    pub const history_pruning_mult: i32 = -2458;
    pub const qs_futility_margin: i32 = 140;
    pub const corrhist_pawn_weight: i32 = 894;
    pub const corrhist_nonpawn_weight: i32 = 756;
    pub const corrhist_countermove_weight: i32 = 1528;
    pub const corrhist_major_weight: i32 = 1291;
    pub const corrhist_minor_weight: i32 = 1061;
    pub const lmp_standard_base: i32 = -3006;
    pub const lmp_improving_base: i32 = -3206;
    pub const lmp_standard_mult: i32 = 906;
    pub const lmp_improving_mult: i32 = 1215;
    pub const see_pawn: i32 = 86;
    pub const see_knight: i32 = 224;
    pub const see_bishop: i32 = 267;
    pub const see_rook: i32 = 337;
    pub const see_queen: i32 = 817;
    pub const material_scaling_base: i32 = 12632;
    pub const material_scaling_pawn: i32 = 40;
    pub const material_scaling_knight: i32 = 448;
    pub const material_scaling_bishop: i32 = 447;
    pub const material_scaling_rook: i32 = 703;
    pub const material_scaling_queen: i32 = 870;
    pub const nodetm_base: i32 = 2071;
    pub const nodetm_mult: i32 = 1048;
    pub const eval_stab_base: i32 = 1223;
    pub const eval_stab_offs: i32 = 51;
    pub const move_stab_base: i32 = 1298;
    pub const move_stab_offs: i32 = 37;
    pub const soft_limit_base: i32 = 51;
    pub const soft_limit_incr: i32 = 650;
    pub const hard_limit_phase_mult: i32 = 112;
    pub const hard_limit_base: i32 = 213;
    pub const singular_beta_mult: i32 = 314;
    pub const singular_depth_mult: i32 = 586;
    pub const singular_depth_offs: i32 = 767;
