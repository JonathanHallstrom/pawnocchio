...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 275;
    pub const quiet_history_bonus_offs: i32 = 318;
    pub const quiet_history_bonus_max: i32 = 3951;
    pub const quiet_history_penalty_mult: i32 = 290;
    pub const quiet_history_penalty_offs: i32 = 345;
    pub const quiet_history_penalty_max: i32 = 1798;
    pub const cont_history_bonus_mult: i32 = 375;
    pub const cont_history_bonus_offs: i32 = 357;
    pub const cont_history_bonus_max: i32 = 2159;
    pub const cont_history_penalty_mult: i32 = 165;
    pub const cont_history_penalty_offs: i32 = 245;
    pub const cont_history_penalty_max: i32 = 2549;
    pub const noisy_history_bonus_mult: i32 = 368;
    pub const noisy_history_bonus_offs: i32 = 516;
    pub const noisy_history_bonus_max: i32 = 1633;
    pub const noisy_history_penalty_mult: i32 = 133;
    pub const noisy_history_penalty_offs: i32 = 164;
    pub const noisy_history_penalty_max: i32 = 1938;
    pub const rfp_base: i32 = 39;
    pub const rfp_mult: i32 = 61;
    pub const rfp_improving_margin: i32 = 51;
    pub const rfp_worsening_margin: i32 = 9;
    pub const rfp_cutnode_margin: i32 = 9;
    pub const aspiration_initial: i32 = 7977;
    pub const aspiration_multiplier: i32 = 1746;
    pub const lmr_quiet_base: i32 = 2341;
    pub const lmr_noisy_base: i32 = 1356;
    pub const lmr_quiet_log_mult: i32 = 188;
    pub const lmr_noisy_log_mult: i32 = 233;
    pub const lmr_quiet_depth_mult: i32 = 878;
    pub const lmr_noisy_depth_mult: i32 = 535;
    pub const lmr_quiet_depth_offs: i32 = -163;
    pub const lmr_noisy_depth_offs: i32 = 255;
    pub const lmr_quiet_legal_mult: i32 = 1216;
    pub const lmr_noisy_legal_mult: i32 = 991;
    pub const lmr_quiet_legal_offs: i32 = 298;
    pub const lmr_noisy_legal_offs: i32 = 70;
    pub const lmr_pv_mult: i32 = 1008;
    pub const lmr_cutnode_mult: i32 = 1299;
    pub const lmr_improving_mult: i32 = 787;
    pub const lmr_quiet_history_mult: i32 = 958;
    pub const lmr_noisy_history_mult: i32 = 611;
    pub const lmr_corrhist_mult: i32 = 12080;
    pub const lmr_ttmove_mult: i32 = 685;
    pub const lmr_dodeeper_margin: i32 = 67;
    pub const nmp_base: i32 = 40793;
    pub const nmp_mult: i32 = 1271;
    pub const nmp_eval_reduction_scale: i32 = 42;
    pub const nmp_eval_reduction_max: i32 = 33113;
    pub const fp_base: i32 = 265;
    pub const fp_mult: i32 = 129;
    pub const qs_see_threshold: i32 = -45;
    pub const see_quiet_pruning_mult: i32 = -40;
    pub const see_noisy_pruning_mult: i32 = -79;
    pub const razoring_margin: i32 = 231;
    pub const history_pruning_mult: i32 = -2320;
    pub const qs_futility_margin: i32 = 124;
    pub const corrhist_pawn_weight: i32 = 962;
    pub const corrhist_nonpawn_weight: i32 = 914;
    pub const corrhist_countermove_weight: i32 = 1638;
    pub const corrhist_major_weight: i32 = 1401;
    pub const corrhist_minor_weight: i32 = 1024;
    pub const lmp_standard_base: i32 = -2767;
    pub const lmp_improving_base: i32 = -3036;
    pub const lmp_standard_mult: i32 = 811;
    pub const lmp_improving_mult: i32 = 1339;
    pub const see_pawn: i32 = 91;
    pub const see_knight: i32 = 241;
    pub const see_bishop: i32 = 256;
    pub const see_rook: i32 = 415;
    pub const see_queen: i32 = 842;
    pub const material_scaling_base: i32 = 12154;
    pub const material_scaling_pawn: i32 = 30;
    pub const material_scaling_knight: i32 = 501;
    pub const material_scaling_bishop: i32 = 429;
    pub const material_scaling_rook: i32 = 748;
    pub const material_scaling_queen: i32 = 965;
    pub const nodetm_base: i32 = 1939;
    pub const nodetm_mult: i32 = 1032;
    pub const eval_stab_base: i32 = 1085;
    pub const eval_stab_offs: i32 = 52;
    pub const move_stab_base: i32 = 1170;
    pub const move_stab_offs: i32 = 36;
    pub const soft_limit_base: i32 = 46;
    pub const soft_limit_incr: i32 = 698;
    pub const hard_limit_phase_mult: i32 = 106;
    pub const hard_limit_base: i32 = 200;
    pub const singular_beta_mult: i32 = 267;
    pub const singular_depth_mult: i32 = 567;
    pub const singular_depth_offs: i32 = 797;
