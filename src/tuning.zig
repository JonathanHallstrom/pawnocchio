...
const tunable_defaults = struct {
    ...
    pub const lmp_improving_base: i32 = 1800;
    pub const lmp_standard_linear_mult: i32 = 500;
    pub const lmp_improving_linear_mult: i32 = 250;
    pub const lmp_standard_quadratic_mult: i32 = 1000;
    pub const lmp_improving_quadratic_mult: i32 = 500;
