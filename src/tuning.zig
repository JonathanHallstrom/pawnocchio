...
const tunable_defaults = struct {
    pub const quiet_history_bonus_mult: i32 = 422;
    pub const quiet_history_bonus_offs: i32 = 441;
    pub const quiet_history_bonus_max: i32 = 3526;
    pub const quiet_history_penalty_mult: i32 = 189;
    pub const quiet_history_penalty_offs: i32 = 357;
    pub const quiet_history_penalty_max: i32 = 1327;
    pub const pawn_history_bonus_mult: i32 = 469;
    pub const pawn_history_bonus_offs: i32 = 450;
    pub const pawn_history_bonus_max: i32 = 2623;
    pub const pawn_history_penalty_mult: i32 = 253;
    pub const pawn_history_penalty_offs: i32 = 406;
    pub const pawn_history_penalty_max: i32 = 1616;
    pub const cont_history_bonus_mult: i32 = 331;
    pub const cont_history_bonus_offs: i32 = 216;
    pub const cont_history_bonus_max: i32 = 3486;
    pub const cont_history_penalty_mult: i32 = 205;
    pub const cont_history_penalty_offs: i32 = 250;
    pub const cont_history_penalty_max: i32 = 1528;
    ...
    pub const noisy_history_penalty_mult: i32 = 232;
    pub const noisy_history_penalty_offs: i32 = 225;
    pub const noisy_history_penalty_max: i32 = 2212;
    pub const high_eval_offs: i32 = 45;
    pub const quiet_ordering_weight: i32 = 1089;
    pub const quiet_pruning_weight: i32 = 957;
    pub const pawn_ordering_weight: i32 = 904;
    pub const pawn_pruning_weight: i32 = 332;
    pub const cont1_ordering_weight: i32 = 1095;
    pub const cont1_pruning_weight: i32 = 903;
    pub const cont2_ordering_weight: i32 = 1000;
    pub const cont2_pruning_weight: i32 = 965;
    pub const cont4_ordering_weight: i32 = 915;
    pub const cont4_pruning_weight: i32 = 95;
    pub const noisy_ordering_weight: i32 = 1041;
    pub const noisy_pruning_weight: i32 = 1061;
    pub const rfp_base: i32 = 42;
    pub const rfp_mult: i32 = 67;
    pub const rfp_improving_margin: i32 = 79;
    ...
    pub const aspiration_initial: i32 = 9876;
    pub const aspiration_multiplier: i32 = 1143;
    pub const lmr_quiet_base: i32 = 3435;
    pub const lmr_noisy_base: i32 = 2007;
    pub const lmr_quiet_log_mult: i32 = 209;
    pub const lmr_noisy_log_mult: i32 = 255;
    pub const lmr_quiet_depth_mult: i32 = 892;
    pub const lmr_noisy_depth_mult: i32 = 750;
    pub const lmr_quiet_depth_offs: i32 = -67;
    pub const lmr_noisy_depth_offs: i32 = 191;
    pub const lmr_quiet_legal_mult: i32 = 1124;
    pub const lmr_noisy_legal_mult: i32 = 1011;
    pub const lmr_quiet_legal_offs: i32 = 29;
    pub const lmr_noisy_legal_offs: i32 = -153;
    pub const lmr_quiet_history_mult: i32 = 663;
    pub const lmr_noisy_history_mult: i32 = 970;
    pub const lmr_corrhist_mult: i32 = 7257;
    pub const lmr_dodeeper_margin: i32 = 55;
    pub const lmr_dodeeper_mult: i32 = 2;
    pub const nmp_base: i32 = 57420;
    pub const nmp_mult: i32 = 1097;
    pub const nmp_eval_reduction_scale: i32 = 24;
    pub const nmp_eval_reduction_max: i32 = 28658;
    pub const fp_base: i32 = 321;
    pub const fp_mult: i32 = 75;
    pub const fp_hist_mult: i32 = 99;
    pub const qs_see_threshold: i32 = -75;
    pub const see_quiet_pruning_mult: i32 = -82;
    pub const see_noisy_pruning_mult: i32 = -54;
    pub const razoring_margin: i32 = 198;
    pub const history_pruning_offs: i32 = 566;
    pub const history_pruning_mult: i32 = -2598;
    pub const qs_futility_margin: i32 = 127;
    pub const qs_hp_margin: i32 = -3718;
    pub const corrhist_pawn_weight: i32 = 741;
    pub const corrhist_nonpawn_weight: i32 = 827;
    pub const corrhist_countermove_weight: i32 = 738;
    pub const corrhist_major_weight: i32 = 1032;
    pub const corrhist_minor_weight: i32 = 1028;
    pub const lmp_standard_base: i32 = 2777;
    pub const lmp_improving_base: i32 = 3256;
    pub const lmp_standard_linear_mult: i32 = -211;
    pub const lmp_improving_linear_mult: i32 = 343;
    pub const lmp_standard_quadratic_mult: i32 = 425;
    pub const lmp_improving_quadratic_mult: i32 = 1140;
    pub const good_noisy_ordering_base: i32 = 4;
    pub const good_noisy_ordering_mult: i32 = 827;
    pub const see_pawn_pruning: i32 = 86;
    pub const see_knight_pruning: i32 = 251;
    pub const see_bishop_pruning: i32 = 309;
    pub const see_rook_pruning: i32 = 507;
    pub const see_queen_pruning: i32 = 967;
    pub const see_pawn_ordering: i32 = 103;
    pub const see_knight_ordering: i32 = 271;
    pub const see_bishop_ordering: i32 = 297;
    pub const see_rook_ordering: i32 = 629;
    pub const see_queen_ordering: i32 = 889;
    pub const mvv_mult: i32 = 733;
    pub const material_scaling_base: i32 = 10287;
    pub const material_scaling_pawn: i32 = 51;
    pub const material_scaling_knight: i32 = 357;
    pub const material_scaling_bishop: i32 = 414;
    pub const material_scaling_rook: i32 = 415;
    pub const material_scaling_queen: i32 = 924;
    pub const multicut_fail_medium: i32 = 90;
    pub const rfp_fail_medium: i32 = 506;
    pub const tt_fail_medium: i32 = 42;
    pub const qs_tt_fail_medium: i32 = 156;
    pub const standpat_fail_medium: i32 = 258;
    pub const nodetm_base: i32 = 1489;
    pub const nodetm_mult: i32 = 1205;
    pub const eval_stab_margin: i32 = 22;
    pub const eval_stab_base: i32 = 1341;
    pub const eval_stab_offs: i32 = 57;
    pub const move_stab_base: i32 = 1317;
    pub const move_stab_offs: i32 = 45;
    pub const soft_limit_base: i32 = 51;
    pub const soft_limit_incr: i32 = 746;
    pub const hard_limit_phase_mult: i32 = 110;
    pub const hard_limit_base: i32 = 229;
    pub const singular_beta_mult: i32 = 438;
    pub const singular_depth_mult: i32 = 548;
    pub const singular_depth_offs: i32 = 883;
    pub const singular_dext_margin: i32 = 15;
    pub const singular_dext_pv_margin: i32 = 22;
    pub const singular_text_margin: i32 = 92;
};
