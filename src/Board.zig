...
pub inline fn halfmoveHash(self: *const Board) u64 {
    return root.zobrist.halfmove(self.halfmove);
}

pub inline fn hashWithHalfmove(self: *const Board) u64 {
    return self.hash ^ self.halfmoveHash();
}
