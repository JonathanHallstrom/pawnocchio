...
pub const SCHEMA = .{
    ...
    .singular_dext_margin_quiet = scalar(.{ .min = 0, .max = 32, .c_end = 2 }),
    .singular_dext_margin_noisy = scalar(.{ .min = 0, .max = 32, .c_end = 2 }),
    .singular_dext_pv_margin = scalar(.{ .min = 0, .max = 32, .c_end = 2 }),
    .singular_dext_corr_mult = scalar(.{ .min = 0, .max = 32, .c_end = 1 }),
