...
fn search(
    ...
    if (tt_hit and !is_pv and !evaluation.isMateScore(tt_entry.score)) {
        ...
        if (tt_entry.flags.score_type != .upper and tt_entry.depth >= fhp(tt_entry.score - beta, depth)) {
            return tt_entry.score;
        }
        if (tt_entry.flags.score_type != .lower and tt_entry.depth >= fhp(alpha - tt_entry.score, depth)) {
            return tt_entry.score;
        }
    }
