        ...
        switch (params.board.stm) {
            inline else => |stm| while (true) {
                ...
                if (score >= aspiration_upper) {
                    aspiration_lower = @intCast(@max(aspiration_upper - (quantized_window >> 10), -evaluation.inf_score));
                    ...
                    aspiration_upper = @intCast(@min(aspiration_lower + (quantized_window >> 10), evaluation.inf_score));
