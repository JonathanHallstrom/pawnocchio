...
fn search(
        ...
        !is_singular_search)
    {
        ...
        if (eval >= beta - tunables.rfp_min_margin) {
            ...
            const opponent_has_easy_capture = board.occupancyFor(stm) & board.lost_squares[stm.flipped().toInt()] != 0;
        ...
        // razoring
        const we_have_easy_capture = board.occupancyFor(stm.flipped()) & board.lost_squares[stm.toInt()] != 0;
